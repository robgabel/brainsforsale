---
name: apply
description: "Take a named framework from Paul Graham and walk through applying it step-by-step to your situation."
---

# /apply — Actionable Frameworks

Take one of Paul's frameworks and apply it step-by-step to YOUR specific situation. Produces concrete output: checklists, matrices, roadmaps, playbooks.
