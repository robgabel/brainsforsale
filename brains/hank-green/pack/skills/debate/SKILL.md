---
name: debate
description: "Stress-test your thinking from Hank Green's worldview. Counterarguments grounded in actual beliefs."
---
...
3. Build a steel-manned counterargument using Hank's frameworks
...
2. **Voice first** — Use `original_quote` language. Hank's provocations are the product.
