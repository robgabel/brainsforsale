---
name: advise
description: "Strategic counsel from Hank Green's thinking. Pulls relevant atoms, synthesizes perspective, cites sources."
---

# /advise — Strategic Counsel

Get strategic advice grounded in Hank Green's frameworks and worldview.

## How It Works

1. Parse the decision — identify the core choice and tradeoffs
2. Search brain atoms — pull the most relevant insights
3. Synthesize what Hank would likely recommend, citing specific atoms
...
1. **Voice first** — When atoms have `original_quote`, use that language. Hank's voice IS the product.
2. **Always cite atoms** — Never synthesize without grounding. If brain is silent on topic, say so.
3. **Use Green's vocabulary** — use his specific terms, frameworks, and labels rather than generic synonyms. The original language IS the insight.
