---
name: evolve
description: "Trace how Sun Tzu's thinking on a topic has evolved over time."
---

# /evolve — Intellectual Evolution

Trace how Sun's thinking on a topic developed over time. Shows the arc: early position → refinements → current stance. The evolution IS the insight.
